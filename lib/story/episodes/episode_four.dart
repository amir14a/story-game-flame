  ...
  return Episode(
    ...
    phases: [
      CutscenePhase(CutsceneConfig(
        ...
        theme: DistrictTheme.steelVeins,
        worldWidth: 36,
        props: const [PropPlacement(CutscenePropKind.streetLamp, x: 28, y: 8.3)],
        beats: [
          PlaceCharacterBeat(Character.james, x: 6, y: 8.3, facing: 1, pose: CharacterPose.idle),
          ...
          MoveCharacterBeat(Character.james, targetX: 20, targetY: 8.3, speed: 3.5),
          ...
          MoveCharacterBeat(Character.james, targetX: 32, targetY: 8.3, speed: 6.0),
        ],
        continueLabel: 'RIDE',
      )),
      ...
      CutscenePhase(CutsceneConfig(
        ...
        beats: [
          ...
          MoveCharacterBeat(Character.millie, targetX: 28, targetY: 8.3, speed: 3.0),
      ...
      CutscenePhase(CutsceneConfig(
        ...
        worldWidth: 30,
        beats: [
          PlaceCharacterBeat(Character.james, x: 12, y: 8.3, facing: 1, pose: CharacterPose.idle),
          ...
          PoseBeat(Character.james, pose: CharacterPose.run),
          MoveCharacterBeat(Character.james, targetX: 26, targetY: 8.3, speed: 6.0),
