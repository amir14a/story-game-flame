  ...
  return Episode(
    ...
    phases: [
      CutscenePhase(CutsceneConfig(
        ...
        theme: DistrictTheme.sunken,
        worldWidth: 36,
        props: const [PropPlacement(CutscenePropKind.dataShard, x: 26, y: 8.0)],
        beats: [
          PlaceCharacterBeat(Character.james, x: 6, y: 8.3, facing: 1, pose: CharacterPose.swim),
          ...
          MoveCharacterBeat(Character.james, targetX: 18, targetY: 8.3, speed: 3.0, pose: CharacterPose.swim),
          ...
          MoveCharacterBeat(Character.james, targetX: 32, targetY: 8.3, speed: 5.0, pose: CharacterPose.swim),
        ],
        continueLabel: 'DIVE',
      )),
      ...
      CutscenePhase(CutsceneConfig(
        ...
        worldWidth: 34,
        beats: [
          PlaceCharacterBeat(Character.millie, x: 8, y: 8.3, facing: 1, pose: CharacterPose.idle),
          ...
          MoveCharacterBeat(Character.millie, targetX: 24, targetY: 8.3, speed: 2.8),
      ...
      CutscenePhase(CutsceneConfig(
        ...
        theme: DistrictTheme.sunken,
        worldWidth: 30,
        props: const [PropPlacement(CutscenePropKind.paperCrane, x: 16, y: 8.1)],
        beats: [
          PlaceCharacterBeat(Character.james, x: 10, y: 8.3, facing: 1, pose: CharacterPose.idle),
          PlaceCharacterBeat(Character.millie, x: 18, y: 8.3, facing: -1, pose: CharacterPose.idle),
          ...
          MoveCharacterBeat(Character.millie, targetX: 12, targetY: 8.3, speed: 4.0),
          PoseBeat(Character.millie, pose: CharacterPose.idle),
