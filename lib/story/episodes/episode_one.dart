  ...
  return Episode(
    ...
    phases: [
      CutscenePhase(CutsceneConfig(
        ...
        worldWidth: 50,
        props: const [
          PropPlacement(CutscenePropKind.paperCrane, x: 8, y: 8.1),
          PropPlacement(CutscenePropKind.windowLights, x: 40, y: 6),
        ],
        beats: [
          PlaceCharacterBeat(Character.james, x: 3, y: 8.3, facing: 1),
          ...
          PauseBeat(0.6),
          MoveCharacterBeat(Character.james, targetX: 7, targetY: 8.3, speed: 3.0),
          PoseBeat(Character.james, pose: CharacterPose.idle),
          PauseBeat(0.4),
          ...
          MoveCharacterBeat(Character.james, targetX: 46, targetY: 8.3, speed: 7.0),
        ],
      ...
      CutscenePhase(CutsceneConfig(
        ...
        worldWidth: 44,
        props: const [
          PropPlacement(CutscenePropKind.windowLights, x: 36, y: 5),
        ],
        beats: [
          PlaceCharacterBeat(Character.james, x: 30, y: 8.3, facing: 1, pose: CharacterPose.idle),
          PlaceCharacterBeat(Character.millie, x: 6, y: 8.3, facing: 1, pose: CharacterPose.idle),
          ...
          LookAtBeat(Character.james, facing: 1),
          MoveCharacterBeat(Character.james, targetX: 40, targetY: 8.3, speed: 5.5),
          PauseBeat(0.2),
          MoveCharacterBeat(Character.millie, targetX: 34, targetY: 8.3, speed: 6.5),
          PoseBeat(Character.james, pose: CharacterPose.idle),
          PoseBeat(Character.millie, pose: CharacterPose.idle),
      ...
      CutscenePhase(CutsceneConfig(
        ...
        worldWidth: 40,
        beats: [
          PlaceCharacterBeat(Character.james, x: 22, y: 8.3, facing: 1, pose: CharacterPose.aim),
          ...
          PoseBeat(Character.james, pose: CharacterPose.fall),
          MoveCharacterBeat(Character.james, targetX: 20, targetY: 14, speed: 4.0, pose: CharacterPose.fall),
