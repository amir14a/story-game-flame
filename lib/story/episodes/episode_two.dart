  ...
  return Episode(
    ...
    phases: [
      CutscenePhase(CutsceneConfig(
        ...
        theme: DistrictTheme.skyway,
        worldWidth: 40,
        props: const [PropPlacement(CutscenePropKind.streetLamp, x: 32, y: 8.3)],
        beats: [
          PlaceCharacterBeat(Character.james, x: 6, y: 8.3, facing: 1, pose: CharacterPose.fall),
          NarrationBeat('James drags himself out of the Sink\'s black water onto the ring-road. '
              ...
              'people own it.'),
          MoveCharacterBeat(Character.james, targetX: 16, targetY: 8.3, speed: 2.5),
          ...
          MoveCharacterBeat(Character.james, targetX: 36, targetY: 8.3, speed: 6.0),
        ],
      ...
      CutscenePhase(CutsceneConfig(
        ...
        worldWidth: 40,
        beats: [
          PlaceCharacterBeat(Character.millie, x: 10, y: 8.3, facing: 1, pose: CharacterPose.seated),
          PlaceCharacterBeat(Character.james, x: 13, y: 8.3, facing: 1, pose: CharacterPose.seated),
          ...
          PoseBeat(Character.james, pose: CharacterPose.idle),
          LookAtBeat(Character.millie, facing: 1),
          MoveCharacterBeat(Character.millie, targetX: 34, targetY: 8.3, speed: 5.0),
          MoveCharacterBeat(Character.james, targetX: 30, targetY: 8.3, speed: 5.0),
      ...
      CutscenePhase(CutsceneConfig(
        ...
        worldWidth: 36,
        beats: [
          PlaceCharacterBeat(Character.james, x: 18, y: 8.3, facing: 1, pose: CharacterPose.idle),
          ...
          MoveCharacterBeat(Character.james, targetX: 18, targetY: 16, speed: 4.0, pose: CharacterPose.fall),
